<?php
/* 'client/agenda/index.php' - Página de Agenda de Experiencias
 * Muestra eventos próximos con detalles como fecha, hora, descripción y cupo.
 * Referencia: Sección 05.5 - Implementación de Agenda
 */
session_start();
...
$page_title = "Agenda — Hotel Salitre";
...
setlocale(LC_TIME, 'es_ES.UTF-8', 'es_MX.UTF-8', 'spanish'); // Intento formatear fecha a español
?>
