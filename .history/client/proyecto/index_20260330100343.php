  ...
  <main id="contenido-principal" class="proyecto-page">
    <section class="proyecto-hero" aria-labelledby="proyecto-hero-title">
      <div class="proyecto-hero__inner fade-in">
        ...
        <p class="proyecto-hero__subtitle">Hotel Salitre es un refugio donde el trabajo remoto encuentra ritmo de costa, luz medida y espacios que respetan tu concentración.</p>
      </div>
    </section>
