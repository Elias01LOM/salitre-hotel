<?php
/* 'client/auth/perfil.php' es la página de perfil del cliente, mostrando su información personal y reservas */
...
/* 
 * Se valida la sesión de cliente antes de mostrar información personal.
 * Sin sesión, redirect a login.php.
 * Referencia: Documentación Sección 08.4
 */
...
/* Obtener datos del cliente con prepared statement */
$stmt = $db->prepare("SELECT * FROM clientes WHERE id = ?");
$stmt->execute([$cliente_id]);
$cliente = $stmt->fetch(PDO::FETCH_ASSOC);

/* Obtener reservas del cliente con JOIN a espacios */
$stmt = $db->prepare("
...
$extra_stylesheets = ["assets/css/client/auth.css"]; // It's variable $extra_stylesheets in header.php
