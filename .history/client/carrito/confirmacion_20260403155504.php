<?php
/* 'client/carrito/confirmacion.php' muestra la página de confirmación de reserva después de que el cliente ha completado el proceso de reserva. Verifica que el cliente esté autenticado, obtiene los detalles de la reserva desde la base de datos usando un ID almacenado en la sesión, y muestra una página con los detalles de la reserva y próximos pasos. */
