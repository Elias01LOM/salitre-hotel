<?php
/* 'agregar.php' maneja la lógica de agregar un espacio al carrito, e asegura de validar los datos, calcular el total correctamente y manejar la sesión del cliente. */
session_start();
