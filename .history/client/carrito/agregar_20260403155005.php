<?php
/* 'clieagregar.php' maneja la lógica de agregar un espacio al carrito, se asegura de validar los datos, calcular el total correctamente y manejar la sesión del cliente. */
session_start();
...
// Calcular noches del lado del backend (Seguridad estricta)
try {
