<?php
/* Definimos el 'home' del sitio web del Hotel Salitre. Muestra una sección hero con video de fondo, propuesta de valor, espacios destacados, servicios adicionales y un formulario de contacto. Utiliza PHP para cargar dinámicamente los espacios disponibles desde la base de datos. */
