<?php
/* Archivo: client/index.php
   Descripción: Página principal del sitio web del Hotel Salitre. Muestra una sección hero con video de fondo, propuesta de valor, espacios destacados, servicios adicionales y un formulario de contacto. Utiliza PHP para cargar dinámicamente los espacios disponibles desde la base de datos. */
...
$page_title        = 'Hotel Salitre · Sal de la oficina. No del trabajo.';
$extra_stylesheets = ['assets/css/client/index.css'];

require __DIR__ . '/includes/header.php';
require __DIR__ . '/includes/nav.php'; // <- La pieza que la IA olvidó
    ...
    <div class="index-container">
      ...
      <div class="hero__actions">
        <a class="btn btn-primary"
           href="<?= htmlspecialchars($base . 'client/espacios/', ENT_QUOTES, 'UTF-8') ?>">
          Ver Espacios
        </a>
