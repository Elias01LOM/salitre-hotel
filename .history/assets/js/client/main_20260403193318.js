...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Cerrar dropdown o menú móvil al hacer click fuera de ellos (en el overlay)
    navOverlay?.addEventListener('click', () => {
        closeDropdown();
        closeMobileMenu();
    });

    // Cerrar dropdown o menú móvil al hacer click en un enlace de navegación
    ...
    // Evitamos que clicks dentro del dropdown o menú cierren el overlay
