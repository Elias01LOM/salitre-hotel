<?php
/* <includes>
<sidebar class="php"></sidebar> define la barra lateral común para todas las páginas del admin, incluyendo el menú de navegación y la información del usuario */
...
<aside class="sidebar" role="complementary" aria-label="Menú de administración">
  ...
  <div class="sidebar__brand">
    <img src="<?= $base ?>assets/img/logo/logo-white.svg" 
         alt="Salitre Admin" 
