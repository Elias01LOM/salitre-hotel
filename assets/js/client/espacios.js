...
// ==================================================
// SALITRE - espacios.js
// Logica para CATÁLOGO (filtros) y DETALLE (calculos de fechas, galería)
// ==================================================

document.addEventListener("DOMContentLoaded", function () {
    
    // --------------------------------------------------
    // 1. FILTROS DEL CATÁLOGO (index.php)
    // --------------------------------------------------
        ...
        filterBtns.forEach(function (btn) {
            btn.addEventListener("click", function () {
                ...
                cards.forEach(card => {
                    ...
                    // Reiniciar animaciones de fade (quitar clase is-visible de animations.js si la tuvieran)
                    ...
                    if (type === "todos" || cardType === type) {
                        ...
                        // Pequeño timeout para forzar re-flow y reactivar transición CSS de la tarjeta
                        setTimeout(() => {
    ...
    // --------------------------------------------------
    // 2. GALERÍA DE DETALLE (detalle.php)
    // --------------------------------------------------
